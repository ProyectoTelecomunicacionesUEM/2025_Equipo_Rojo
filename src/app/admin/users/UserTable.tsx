...
export default function UserTable({
  ...
  return (
    <div style={{ position: "relative", minHeight: "100vh" }}>
      ...
      {/* --- Barra de usuario arriba del todo --- */}
      <div
        style={{
          position: "fixed",
          top: 0,
      ...
      >
        {session?.user?.email && (
          <span style={{ marginRight: 12, fontWeight: 600, color: "#333" }}>
            {session.user.email}
          </span>
        )}
        <button
      ...
      {/* --- Contenido principal --- */}
      <div style={{ paddingTop: 60, padding: 12 }}>
        {/* --- Buscador y filtros --- */}
        <form
          action="/admin/users"
          method="get"
        ...
        >
          ...
          <button
            type="submit"
            style={{ flex: 1, background: "#0b5fff", color: "#fff", border: "none", borderRadius: 6, padding: "8px 12px", height: 36, cursor: "pointer" }}
          >
            Buscar
          </button>
          <button
        ...
        {/* --- Tabla --- */}
        <table style={{ width: "100%", borderCollapse: "collapse", marginTop: 12 } as React.CSSProperties}>
          <thead>
            <tr>
              <th style={th} />
...
const btn: React.CSSProperties = { background: "#0b5fff", color: "#fff", border: "none", borderRadius: 6, padding: "8px 12px", cursor: "pointer" };
const btnDanger: React.CSSProperties = { background: "#e53935", color: "#fff", border: "none", borderRadius: 6, padding: "8px 12px", cursor: "pointer" };
